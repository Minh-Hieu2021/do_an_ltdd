...
import 'package:do_an_ltdd/sceens/product/childetailproduct.dart';
...
class _DetailsScreenState extends State<DetailsScreen>{
    ...
    body:  Center(
      child: ListView(
        children: <Widget>[
          ...
          Row(children: <Widget>[ // Tiền mới tiền cũ
            Padding(
              padding: const EdgeInsets.only(left: 10),
              child: Text(
                "\$${products[0].price}",
          ...
          Row(children: <Widget>[
            ...
            ElevatedButton(
              ...
              child: Column(
                children: <Widget>[
                  Padding(padding: const EdgeInsets.all(5),child: Image.asset(products[0].image)),
                  Padding(padding: const EdgeInsets.all(5),child: Text(products[0].title, style: const TextStyle(color: Colors.red, fontSize: 15),),),
                  Row(children: <Widget>[ // Tiền mới tiền cũ
                    Padding(
                      padding: const EdgeInsets.only(left: 10),
                      child: Text(
          ...
          Column(
            ...
            children: const <Widget>[ //Thông tin chi tiết
          ...
          Row(
            children: <Widget>[
              Expanded(
                child: Column(  // Tên các Thông tin chi tiết
                  crossAxisAlignment: CrossAxisAlignment.start,
              ...
              Expanded(
                child: Column(  // Thông tin chi tiết được lấy lên từ products
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    Padding(
          ...
          Column(
            crossAxisAlignment: CrossAxisAlignment.start,
            children: <Widget>[ //Mô tả sản phẩm
              const Padding(
                padding: EdgeInsets.all(10),
                child: Text(
                  "Mô tả sản phẩm",
          ...
          Row(children: const <Widget>[ //Khách hàng đánh giá
            Padding(
              padding: EdgeInsets.all(10),
              child: Text(
                "Khách hàng đánh giá",
          ...
          Row(children: [ //Mua hàng và thêm vào giỏ hàng
            Padding(
              ...
              child: Expanded(
                child: Column(children: <Widget>[
                  ElevatedButton(
                    ...
                    onPressed: () {},
                    child: const Text('Mua hàng', style: TextStyle(fontSize: 20)),
                  ),
                ]),
              ),
            ),
              ...
              child: Expanded(
                child: Column(children: <Widget>[
                  ElevatedButton(
                    ...
                    onPressed: () {},
                    child: const Text('Thêm vào giỏ hàng', style: TextStyle(fontSize: 20)),
                  ),
                ]),
              ),
            ),
  ...
  AppBar buildAppbar(BuildContext context) { //Thanh công cụ
    return AppBar(
